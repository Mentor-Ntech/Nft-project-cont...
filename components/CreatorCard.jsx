...
//           <Image src={creatorImage} fill objectFit='cover' alt='creator' className='rounded-full'/>

//           <div className='absolute w-4 h-4 minlg:w-7 minlg:h-7 bottom-2 -right-0'>
//             <Image src={images.tick} fill objectFit='contain'/>
//           </div>
//         </div>
//       </div>

//       <div className='mt-3 minlg:mt-7 text-center flexCenter flex-col'>
//         <p className='mt-1 font-poppins dark:text-white text-nft-black-1 font-semibold text-base'>{creatorName}</p>
    ...
    <div className='min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4'>
      ...
      <div className='my-2 flex justify-center'>
        <div className='relative w-20 h-20 minlg:w-28 minlg:h-28'>
          <Image src={creatorImage} fill objectFit='cover' alt='creator' className='rounded-full' />
          <div className='absolute w-4 h-4 minlg:w-7 minlg:h-7 bottom-2 -right-0'>
            <Image src={tick} fill objectFit='contain' alt='tick' />
          </div>
        </div>
      </div>
      <div className='mt-3 minlg:mt-7 text-center flexCenter flex-col'>
        ...
        <p className='mt-1 font-poppins dark:text-white text-nft-black-1 font-semibold text-base'>
          {typeof creatorEths === 'number' ? creatorEths.toFixed(2) : '0.00'} <span className='font-normal'>ETH</span>
        </p>
      </div>
    </div>
  );
